...
pixi add cupy cupy-core
# for installing globally
pixi global install cupy cupy-core
```
...
It is possible to list all of the versions of `cupy` available on your platform:
...
```
pixi search cupy --channel conda-forge
```
